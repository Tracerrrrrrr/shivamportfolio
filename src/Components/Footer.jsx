...
export default function Footer() {
  return (
    <footer className="relative w-full" style={{ marginTop: "3rem" }}>
      <div className="mx-auto w-full max-w-7xl px-8">
        <div className="mt-12 flex flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
          ...
          >
            &copy; {currentYear} Shivam Upadhyay. All Rights Reserved.
          </Typography>
          <div className="flex gap-4 text-blue-gray-900 items-center">
            <Typography
              as="a"
              href="#"
